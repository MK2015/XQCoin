...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "XQCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    // {"www.XQC-coin.com", "www.XQC-coin.com"},
...
unsigned int pnSeed[] =
{
	// 0x6b820431, //49.4.130.107
	// 0xb3a1a43d, //61.164.161.179
	// 0xed9c1c73,  //115.28.156.237
	// 0x172dc779,         //121.199.45.23
	// 0x1204c779,        //121.199.4.18    
	// 0x6482f4da,        //218.244.130.100
    // 0xd8c195d3,  //211.149.193.216
     // 0xc2af95d3,  //211.149.175.194
     // 0x71c395d3,  //211.149.195.113
	 // 0x6b820431, //49.4.130.107
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. XQCoin is probably already running."), addrBind.ToString().c_str());
        else
